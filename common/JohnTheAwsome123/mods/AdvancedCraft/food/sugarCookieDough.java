...
public class sugarCookieDough extends ItemFood
{
    ...
    public sugarCookieDough(int par1, int hungerFill, float saturation, boolean wolvesFood)
    {
        super(par1, hungerFill, saturation, wolvesFood);
        this.setCreativeTab(AdvancedCraft.tabAdvancedCraft);
        this.setUnlocalizedName("sugarCookieDough");
        this.setMaxStackSize(64);
    }
    public sugarCookieDough(int par1, int hungerFill, boolean wolvesFood)
    {
    ...
    public void registerIcons(IconRegister par1registerIcon){
        this.itemIcon = par1registerIcon.registerIcon("AdvancedCraft:food/sugarCookieDough");
    }
