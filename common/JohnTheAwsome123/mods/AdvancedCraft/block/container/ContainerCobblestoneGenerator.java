...
{
    protected TileEntityCobblestoneGenerator tileEntity;

    public ContainerCobblestoneGenerator (InventoryPlayer inventoryPlayer, TileEntityCobblestoneGenerator te){
            tileEntity = te;
