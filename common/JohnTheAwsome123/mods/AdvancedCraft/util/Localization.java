...
public class Localization
{
    ...
    private static void load(String path, String default_language)
    {
        ...
        try
        {
            ...
            LanguageRegistry.instance().addStringLocalization(modMappings, default_language);
            ...
            if (langStream != null)
            {
                modMappings.clear();
                modMappings.load(langStream);
                LanguageRegistry.instance().addStringLocalization(modMappings, getCurrentLanguage());
            }
    ...
    {
        return AdvancedCraft.proxy.getCurrentLanguage();
    }
}
