...
public class ACTextures
{
    ...
    public static String GetTextureNameFull(Item item, String subFolders){
        return ACTextures.RESOURCE_CONTEXT + ":" + subFolders + ACTextures.FormatUnlocalized(item);
    }
    public static String GetTextureNameFull(Block block, String subFolders){
        return ACTextures.RESOURCE_CONTEXT + ":" + subFolders + ACTextures.FormatUnlocalized(block);
    }
   ...
   // Models //
//    public static final ResourceLocation MODEL_ROCKET = new ResourceLocation(RESOURCE_CONTEXT, "textures/entities/fuselage.png");
//    public static final ResourceLocation MODEL_COM_SATELLITE=new ResourceLocation(RESOURCE_CONTEXT,"textures/entities/comSatelliteBase.png");
